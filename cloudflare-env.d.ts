/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: f23cac8e35f7e137e0fc9bd52d341a4c)
...
declare namespace Cloudflare {
	interface Env {
		...
		ASSETS: Fetcher;
		WORKER_SELF_REFERENCE: Fetcher /* klipcode */;
	}
}
