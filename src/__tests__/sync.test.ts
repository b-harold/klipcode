...
import type { CloudFolderRow, CloudNoteRow, CloudSnippetRow, FolderRecord, SnippetRecord } from "@/lib/types";
...
type Cloud = { folders: CloudFolderRow[]; snippets: CloudSnippetRow[]; notes: CloudNoteRow[] };
const cloud: Cloud = { folders: [], snippets: [], notes: [] };

const fakeClient = {
  from(table: "folders" | "snippets" | "notes") {
    return {
      select() {
        return {
